...
public class NavigationDrawerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDrawerListView.setAdapter(new NavDrawerAdapter(titles,icons));

        mNavDrawerAdapter = new NavDrawerAdapter(titles,icons);
        mNavDrawerAdapter.setSelectedPosition(mCurrentSelectedPosition);

        mDrawerListView.setAdapter(mNavDrawerAdapter);
        mNavDrawerAdapter.addOnItemClickListener(mRecitemClickListener);
    ...
    private ItemClickListener mRecitemClickListener = new ItemClickListener() {
        @Override
